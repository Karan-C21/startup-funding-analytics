WITH boom AS (
SELECT o.industrygrouptype, COUNT(*) AS deal_count, ROUND(SUM(o.totalamountsold)/1000000000,2) AS total_amount
...
bust AS (
SELECT o.industrygrouptype, COUNT(*) AS deal_count, ROUND((SUM(o.totalamountsold)/1000000000)/3,2) AS total_amount
FROM submissions s JOIN offerings o ON 
s.accession_number = o.accession_number
